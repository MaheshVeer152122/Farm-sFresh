...
public class AdminDaoImpl implements IAdminDao {
	...
	public List<Category> getAllCategory() {
		String jpql = "SELECT NEW com.fresh.pojos.Category(c.categoryId, c.categoryName) FROM Category c";
		return mgr.createQuery(jpql, Category.class).getResultList();
	}
	
	@Override
	public List<OrderDetails> getAllOrders() {
		String jpql = "SELECT NEW com.fresh.pojos.OrderDetails(o.id, o.orderItem, o.quantity, o.amount, o.orders) FROM OrderDetails o";
		return mgr.createQuery(jpql, OrderDetails.class).getResultList();
	}

	@Override
	public List<User> getAllUser() {
		String jpql = "SELECT NEW com.fresh.pojos.User(u.userId, u.email, u.password, u.phoneNo, u.address,"
